...
|---|---|---|---|---|---|
| 1 | [#49 Credenciales BD Incompletas](https://github.com/Blap00/Petshop-Project/issues/49) | PR FIX #49](https://github.com/DiegoCS06/Petshop-Project/pull/5) | José Daniel Valerio | ✅ Build passing | Cerrado con comentario |
| 2 | [#50 Inconsistencia en BD](https://github.com/Blap00/Petshop-Project/issues/50) | PR FIX #50](https://github.com/DiegoCS06/Petshop-Project/pull/6) | José Daniel Valerio | ✅ Build passing | Cerrado con comentario |
| 3 | [#51 Datos de prueba ausentes](https://github.com/Blap00/Petshop-Project/issues/51) | PR FIX #51](https://github.com/DiegoCS06/Petshop-Project/pull/7) | José Daniel Valerio| ✅ Build passing | Cerrado con comentario |
| 4 | [#52 Instrucciones específicas para un IDE](https://github.com/Blap00/Petshop-Project/issues/52) | PR FIX #52](https://github.com/DiegoCS06/Petshop-Project/pull/6) | José Daniel Valerio | ✅ Build passing | Cerrado con comentario |
